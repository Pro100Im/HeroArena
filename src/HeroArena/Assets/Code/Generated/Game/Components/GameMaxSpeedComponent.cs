...
public partial class GameEntity {
    ...
    public Code.Game.Features.Movement.MaxSpeed maxSpeed { get { return (Code.Game.Features.Movement.MaxSpeed)GetComponent(GameComponentsLookup.MaxSpeed); } }
    ...
    public void AddMaxSpeed(float newValue) {
        ...
        var component = (Code.Game.Features.Movement.MaxSpeed)CreateComponent(index, typeof(Code.Game.Features.Movement.MaxSpeed));
